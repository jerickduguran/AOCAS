...
$.fn.smartwizardJM = function(action){    
        var options = $.extend({}, $.fn.smartwizardJM.defaults, action);
        var args = arguments; 
        return this.each(function(){
                ...
                if (!action || action === 'init' || typeof action === 'object') {
                  ...
                  return true;
                }else if (action === 'triggerForwardAfterAjax') {
                  var ar =  Array.prototype.slice.call( args, 1 );
                  triggerForwardAfterAjax(ar[0].stepnum);
                  return true;
                } else {
				...
				function triggerForwardAfterAjax(stepnum){
					doForwardProgress();
				}
        });  
	} 
