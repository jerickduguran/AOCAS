<div class="formBodyContent">
	<form action="<?php echo url_for("groupcode/update?id=").$form->getObject()->getId();?>"  method="post" id="form_groupcode">
		<?php echo $form->renderHiddenFields();?>
	<h4>Edit Group Code</h4> 
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
			A unique code/number for this groupcode (limited to 8 characters)
		</div>
	</div>
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
		A short title for this groupcode (limited to 100 characters)
		</div>
	</div>
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
		A description of this groupcode
		</div>
	</div>  
	
	<div class="formControlBtn" align="right"> 
			<a href="<?php echo url_for("groupcode/index");?>" class="btnBack">Back</a> 
			<a href="javascript:document.getElementById('form_groupcode').reset();" class="btnCancel">Reset</a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		$("#btnSaveAndContinue").click(function(){
			$("form#form_groupcode").submit();
		});
	
	var validator = $("form#form_groupcode").validate({		 
		rules: {		
			'<?php echo $form['code']->renderName();?>': {
					  required: true, 
					  remote: {
							url: "<?php echo url_for("groupcode/checkcode");?>",
							type: "post",
							data: {
