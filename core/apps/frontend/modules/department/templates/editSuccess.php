<div class="formBodyContent">
	<form action="<?php echo url_for("department/update?id=").$form->getObject()->getId();?>"  method="post" id="form_department">
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
			A unique code/number for this department (limited to 8 characters)
		</div>
	</div>
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
		A short title for this department (limited to 100 characters)
		</div>
	</div>
	...
	<div class="formControlBtn" align="right"> 
		...
		<a href="javascript:document.getElementById('form_department').reset();" class="btnCancel">Reset</a>  
		<a href="<?php echo url_for("department/index");?>" class="btnCancel">Cancel</a>   	
	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		$(".btnSave").click(function(){
			$("form#form_department").submit();
		});
	
	var validator = $("form#form_department").validate({		 
		rules: {		
			'<?php echo $form['code']->renderName();?>': {
					  required: true, 
					  remote: {
							url: "<?php echo url_for("department/checkcode");?>",
							type: "post",
							data: {
