...
<?php end_slot();?>
	...
	<form action="<?php echo url_for("arbeginningbalance/update?id=").$form->getObject()->getId();?>"  method="post" id="form_arbeginningbalance">
		<?php echo $form->renderHiddenFields();?>
				<div class="formBodyContent">
				<h4>Update receivable beginning balances schedule</h4> 
				<div class="formControlBtnTop" align="right"> 
					<a href="<?php echo url_for("arbeginningbalance/index");?>" class="btnBack">Back</a> 
					<a href="javascript:document.getElementById('form_arbeginningbalance').reset();" class="btnCancel">Reset</a>
            ...
            <div class="rightBalances">
                <h4>
            	Beginning Balances for Accounts Receivable
                </h4>               
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		...
		$(".btnSave").click(function(){
			$("form#form_arbeginningbalance").submit();
		});
	
		var validator = $("form#form_arbeginningbalance").validate({		 
		rules: { 
