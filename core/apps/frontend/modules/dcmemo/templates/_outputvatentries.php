    ...
    <div class="popupVAT">
        ...
        <div class="transactionEntry">
            ...
            <div class="transactionInfo">
               <?php echo $form['receipt_number']->render(array('value'=>$data['receipt_number']));?>
        ...
        <div class="popupEntry account_outputvat_entry_wrap">
			...
			<?php $total_entries = 0;?>
			<?php if(count($form['ReceiptAccountEntryOutputVatEntry']) > 0):?>
				<?php foreach($form['ReceiptAccountEntryOutputVatEntry'] as $ov_entry_form):?>
...
<script type="text/javascript">
	...
	{
			$.ajax({
					url: '<?php echo url_for("or/addOutputVatEntry?num=");?>'+ (new_output_entry_count + 1),
					type: 'POST',
					dataType: 'json',
