...
<?php end_slot();?> 
 <div class="formBodyContent"> 
		<form action="<?php echo url_for("taxexpandedwithheld/create");?>"  method="post" id="form_tsxexpandedwithheld">
				<?php echo $form->renderHiddenFields();?>
        	<h4>Add Tax Rate</h4> 
                <div class="formControlBtnTop" align="right">
                    <a href="<?php echo url_for("taxexpandedwithheld/index");?>" class="btnBack">Back</a> 
					<a href="javascript:document.getElementById('form_tsxexpandedwithheld').reset();" class="btnCancel">Reset</a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		$(".btnSave").click(function(){
			$("form#form_tsxexpandedwithheld").submit();
		});
	
	var validator = $("form#form_tsxexpandedwithheld").validate({		 
		rules: {		
			'<?php echo $form['code']->renderName();?>': {
					  required: true, 
					  remote: {
							url: "<?php echo url_for("taxexpandedwithheld/checkcode");?>",
							type: "post",
							data: {
