<div class="popupMain init_add_pc_voucher">
	<div class="popup">
		<form action="<?php echo url_for("pettycashvoucher/presavepcvoucher");?>" method="post" id="form_create_pc_voucher">
			<?php echo $form->renderHiddenFields();?>
			<h3>POetty Cash Voucher Entry</h3>		
			<div class="popupBody">
				<div class="popTitle">
					Book
				</div>
