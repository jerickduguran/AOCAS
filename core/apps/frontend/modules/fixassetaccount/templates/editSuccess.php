<div class="formBodyContent">
	<form action="<?php echo url_for("fixassetaccount/update?id=").$form->getObject()->getId();?>"  method="post" id="form_fixassetaccount">
		<?php echo $form->renderHiddenFields();?>
	<h4>Edit Fix Asset Account</h4> 
	<div class="formControl">
		<div id="error" style="display:none;"></div>
	</div>
	<div class="formControl">
		<div class="formControlTitle">Acccount Code</div>
		<div> 
			<?php echo $form['chart_of_account_id']->render(array('class'=>'formControlSelect'));?>
		</div>
		<div class="formControlDesc">
			A unique code/number for this fixassetaccount (limited to 8 characters)
		</div>
	</div>
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
		A short title for this fixassetaccount (limited to 100 characters)
		</div>
	</div>
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
		A description of this fixassetaccount
		</div>
	</div> 
	
	<div class="formControlBtn" align="right"> 
			<a href="<?php echo url_for("fixassetaccount/index");?>" class="btnBack">Back</a> 
			<a href="javascript:document.getElementById('form_fixassetaccount').reset();" class="btnCancel">Reset</a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		$("#btnSaveAndContinue").click(function(){
			$("form#form_fixassetaccount").submit();
		});
		
		var validator = $("form#form_fixassetaccount").validate({		 
			rules: {		
				'<?php echo $form['code']->renderName();?>': {
						  required: true, 
						  remote: {
								url: "<?php echo url_for("fixassetaccount/checkcode");?>",
								type: "post",
								data: {
				...
				'<?php echo $form['chart_of_account_id']->renderName();?>': "required",
