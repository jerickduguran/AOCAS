<div class="popupMain init_add_journal_voucher">
	<div class="popup">
		<form action="<?php echo url_for("journalvoucher/presavejournalvoucher");?>" method="post" id="form_create_journal_voucher">
			<?php echo $form->renderHiddenFields();?>
			<h3>Journal Voucher Entry</h3>		
			<div class="popupBody">
				<div class="popTitle">
					Book
				</div>
