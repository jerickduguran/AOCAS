<div class="formBodyContent">
	<form action="<?php echo url_for("industry/update?id=").$form->getObject()->getId();?>"  method="post" id="form_industry">
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
			A unique code/number for this industry (limited to 8 characters)
		</div>
	</div>
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
		A short title for this industry (limited to 100 characters)
		</div>
	</div>
	...
	<div class="formControl">
		...
		<div class="formControlDesc">
		A description of this industry
		</div>
	</div>  
	
	<div class="formControlBtn" align="right"> 
			<a href="<?php echo url_for("industry/index");?>" class="btnBack">Back</a> 
			<a href="javascript:document.getElementById('form_industry').reset();" class="btnCancel">Reset</a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){ 
		$("#btnSaveAndContinue").click(function(){
			$("form#form_industry").submit();
		});
	
	var validator = $("form#form_industry").validate({		 
		rules: {		
			'<?php echo $form['code']->renderName();?>': {
					  required: true, 
					  remote: {
							url: "<?php echo url_for("industry/checkcode");?>",
							type: "post",
							data: {
