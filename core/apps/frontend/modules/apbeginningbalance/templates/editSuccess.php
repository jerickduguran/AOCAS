...
<?php end_slot();?>
	...
	<form action="<?php echo url_for("apbeginningbalance/update?id=").$form->getObject()->getId();?>"  method="post" id="form_apbeginningbalance">
		<?php echo $form->renderHiddenFields();?>
				<div class="formBodyContent">
				<h4>Update payable beginning balances schedule</h4> 
