...
/**
 * ParticularTemplateEntry form base class.
 *
 * @method ParticularTemplateEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseParticularTemplateEntryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'particular_template_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ParticularTemplate'))),
    ...
    $this->widgetSchema->setNameFormat('particular_template_entry[%s]');
  ...
  {
    return 'ParticularTemplateEntry';
  }
