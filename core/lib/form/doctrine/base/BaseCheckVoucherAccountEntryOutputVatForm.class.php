...
/**
 * CheckVoucherAccountEntryOutputVat form base class.
 *
 * @method CheckVoucherAccountEntryOutputVat getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseCheckVoucherAccountEntryOutputVatForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                   => new sfWidgetFormInputHidden(),
      'check_voucher_number' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'check_voucher_number' => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('check_voucher_account_entry_output_vat[%s]');
  ...
  {
    return 'CheckVoucherAccountEntryOutputVat';
  }
