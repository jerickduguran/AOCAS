...
/**
 * ReceiptAccountEntryOutputVat form base class.
 *
 * @method ReceiptAccountEntryOutputVat getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseReceiptAccountEntryOutputVatForm extends BaseFormDoctrine
{
