...
/**
 * PettyCashVoucherVoucherParticularEntry form base class.
 *
 * @method PettyCashVoucherVoucherParticularEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePettyCashVoucherVoucherParticularEntryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_voucher_particular_entry[%s]');
