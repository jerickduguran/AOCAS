...
/**
 * JournalBookTemplate form base class.
 *
 * @method JournalBookTemplate getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseJournalBookTemplateForm extends BaseFormDoctrine
{
