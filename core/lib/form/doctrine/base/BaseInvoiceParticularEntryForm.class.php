...
/**
 * InvoiceParticularEntry form base class.
 *
 * @method InvoiceParticularEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseInvoiceParticularEntryForm extends BaseFormDoctrine
{
