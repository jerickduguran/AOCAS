...
/**
 * PettyCashVoucherAccountEntry form base class.
 *
 * @method PettyCashVoucherAccountEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePettyCashVoucherAccountEntryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_account_entry[%s]');
  ...
  {
    return 'PettyCashVoucherAccountEntry';
  }
