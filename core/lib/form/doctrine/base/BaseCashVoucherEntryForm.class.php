...
/**
 * CashVoucherEntry form base class.
 *
 * @method CashVoucherEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseCashVoucherEntryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cash_voucher_entry[%s]');
