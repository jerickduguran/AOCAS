...
/**
 * InvoiceAccountEntryOutputVat form base class.
 *
 * @method InvoiceAccountEntryOutputVat getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseInvoiceAccountEntryOutputVatForm extends BaseFormDoctrine
{
