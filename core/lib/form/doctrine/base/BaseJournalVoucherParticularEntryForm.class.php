...
/**
 * JournalVoucherParticularEntry form base class.
 *
 * @method JournalVoucherParticularEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseJournalVoucherParticularEntryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('journal_voucher_particular_entry[%s]');
