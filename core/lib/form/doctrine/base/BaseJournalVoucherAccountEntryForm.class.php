...
/**
 * JournalVoucherAccountEntry form base class.
 *
 * @method JournalVoucherAccountEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseJournalVoucherAccountEntryForm extends BaseFormDoctrine
{
