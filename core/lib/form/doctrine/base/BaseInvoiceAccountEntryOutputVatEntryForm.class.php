...
/**
 * InvoiceAccountEntryOutputVatEntry form base class.
 *
 * @method InvoiceAccountEntryOutputVatEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseInvoiceAccountEntryOutputVatEntryForm extends BaseFormDoctrine
{
