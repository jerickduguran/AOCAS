...
/**
 * RolePrivileges form base class.
 *
 * @method RolePrivileges getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseRolePrivilegesForm extends BaseFormDoctrine
{
