...
/**
 * ReceiptParticularEntry form base class.
 *
 * @method ReceiptParticularEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseReceiptParticularEntryForm extends BaseFormDoctrine
{
