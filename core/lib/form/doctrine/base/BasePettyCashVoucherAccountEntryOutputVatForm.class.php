...
/**
 * PettyCashVoucherAccountEntryOutputVat form base class.
 *
 * @method PettyCashVoucherAccountEntryOutputVat getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePettyCashVoucherAccountEntryOutputVatForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_account_entry_output_vat[%s]');
  ...
  {
    return 'PettyCashVoucherAccountEntryOutputVat';
  }
