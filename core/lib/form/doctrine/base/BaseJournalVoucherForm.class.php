...
/**
 * JournalVoucher form base class.
 *
 * @method JournalVoucher getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseJournalVoucherForm extends BaseFormDoctrine
{
