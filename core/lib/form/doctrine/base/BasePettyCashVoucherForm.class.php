...
/**
 * PettyCashVoucher form base class.
 *
 * @method PettyCashVoucher getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePettyCashVoucherForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'status'             => new sfValidatorChoice(array('choices' => array(0 => 'UNPAID', 1 => 'PARTIAL_PAID', 2 => 'FULL_PAID'), 'required' => false)),
