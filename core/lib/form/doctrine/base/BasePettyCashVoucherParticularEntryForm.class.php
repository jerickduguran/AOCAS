...
/**
 * PettyCashVoucherParticularEntry form base class.
 *
 * @method PettyCashVoucherParticularEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePettyCashVoucherParticularEntryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                       => new sfWidgetFormInputHidden(),
      'petty_cash_voucher_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PettyCashVoucher'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'petty_cash_voucher_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('PettyCashVoucher'))),
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_particular_entry[%s]');
  ...
  {
    return 'PettyCashVoucherParticularEntry';
  }
