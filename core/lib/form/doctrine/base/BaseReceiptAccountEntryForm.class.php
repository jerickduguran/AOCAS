...
/**
 * ReceiptAccountEntry form base class.
 *
 * @method ReceiptAccountEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseReceiptAccountEntryForm extends BaseFormDoctrine
{
