...
/**
 * DebitCreditMemo form base class.
 *
 * @method DebitCreditMemo getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseDebitCreditMemoForm extends BaseFormDoctrine
{
