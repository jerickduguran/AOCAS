...
/**
 * AccountsPayableBeginningBalance form base class.
 *
 * @method AccountsPayableBeginningBalance getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseAccountsPayableBeginningBalanceForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('accounts_payable_beginning_balance[%s]');
