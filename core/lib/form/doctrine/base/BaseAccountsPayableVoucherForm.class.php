...
/**
 * AccountsPayableVoucher form base class.
 *
 * @method AccountsPayableVoucher getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseAccountsPayableVoucherForm extends BaseFormDoctrine
{
