...
/**
 * CheckVoucherParticularEntry form base class.
 *
 * @method CheckVoucherParticularEntry getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseCheckVoucherParticularEntryForm extends BaseFormDoctrine
{
