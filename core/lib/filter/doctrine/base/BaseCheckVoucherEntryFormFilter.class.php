...
/**
 * CheckVoucherEntry filter form base class.
 *
 ...
 */
abstract class BaseCheckVoucherEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('check_voucher_entry_filters[%s]');
