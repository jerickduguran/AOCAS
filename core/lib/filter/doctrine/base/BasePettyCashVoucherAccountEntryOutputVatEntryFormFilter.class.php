...
/**
 * PettyCashVoucherAccountEntryOutputVatEntry filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherAccountEntryOutputVatEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'petty_cash_voucher_account_entry_output_vat_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PettyCashVoucherAccountEntryOutputVat'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_account_entry_output_vat_entry_filters[%s]');
