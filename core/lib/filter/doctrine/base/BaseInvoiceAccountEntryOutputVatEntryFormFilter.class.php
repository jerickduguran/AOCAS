...
/**
 * InvoiceAccountEntryOutputVatEntry filter form base class.
 *
 ...
 */
abstract class BaseInvoiceAccountEntryOutputVatEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'invoice_account_entry_output_vat_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('InvoiceAccountEntryOutputVat'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('invoice_account_entry_output_vat_entry_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                                  => 'Number',
      'invoice_account_entry_output_vat_id' => 'ForeignKey',
