...
/**
 * PettyCashVoucherVoucherAccountEntryOutputVat filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherVoucherAccountEntryOutputVatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'petty_cash_voucher_number' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      'petty_cash_voucher_number' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_voucher_account_entry_output_vat_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                        => 'Number',
      'petty_cash_voucher_number' => 'Number',
