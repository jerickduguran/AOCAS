...
/**
 * DebitCreditMemoParticularEntry filter form base class.
 *
 ...
 */
abstract class BaseDebitCreditMemoParticularEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'debit_credit_memo_id'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('DebitCreditMemo'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'debit_credit_memo_id'     => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('DebitCreditMemo'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('debit_credit_memo_particular_entry_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                       => 'Number',
      'debit_credit_memo_id'     => 'ForeignKey',
      'title'                    => 'Text',
      'amount'                   => 'Number',
