...
/**
 * PettyCashVoucherVoucherParticularEntry filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherVoucherParticularEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'petty_cash_voucher_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PettyCashVoucherVoucher'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'petty_cash_voucher_id'    => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PettyCashVoucherVoucher'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_voucher_particular_entry_filters[%s]');
  ...
  {
    return 'PettyCashVoucherVoucherParticularEntry';
  }
  ...
  public function getFields()
  {
    return array(
      'id'                       => 'Number',
      'petty_cash_voucher_id'    => 'ForeignKey',
      'title'                    => 'Text',
      'amount'                   => 'Number',
