...
/**
 * JournalVoucherAccountEntry filter form base class.
 *
 ...
 */
abstract class BaseJournalVoucherAccountEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('journal_voucher_account_entry_filters[%s]');
  ...
  {
    return 'JournalVoucherAccountEntry';
  }
