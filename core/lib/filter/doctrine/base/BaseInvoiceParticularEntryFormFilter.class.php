...
/**
 * InvoiceParticularEntry filter form base class.
 *
 ...
 */
abstract class BaseInvoiceParticularEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('invoice_particular_entry_filters[%s]');
