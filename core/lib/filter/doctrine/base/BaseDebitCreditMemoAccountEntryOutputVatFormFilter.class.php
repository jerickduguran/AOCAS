...
/**
 * DebitCreditMemoAccountEntryOutputVat filter form base class.
 *
 ...
 */
abstract class BaseDebitCreditMemoAccountEntryOutputVatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'debit_credit_memo_number' => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('debit_credit_memo_account_entry_output_vat_filters[%s]');
