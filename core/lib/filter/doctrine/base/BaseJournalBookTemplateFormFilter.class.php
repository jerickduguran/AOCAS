...
/**
 * JournalBookTemplate filter form base class.
 *
 ...
 */
abstract class BaseJournalBookTemplateFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('journal_book_template_filters[%s]');
  ...
  public function addJournalBookListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('JournalBookBookTemplate.journal_book_id', $values)
    ;
  }

  public function getModelName()
  {
    return 'JournalBookTemplate';
  }
