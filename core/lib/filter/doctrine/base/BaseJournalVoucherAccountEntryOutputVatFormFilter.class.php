...
/**
 * JournalVoucherAccountEntryOutputVat filter form base class.
 *
 ...
 */
abstract class BaseJournalVoucherAccountEntryOutputVatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'journal_voucher_number' => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('journal_voucher_account_entry_output_vat_filters[%s]');
