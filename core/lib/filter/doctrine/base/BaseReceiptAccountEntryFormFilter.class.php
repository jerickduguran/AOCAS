...
/**
 * ReceiptAccountEntry filter form base class.
 *
 ...
 */
abstract class BaseReceiptAccountEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('receipt_account_entry_filters[%s]');
