...
/**
 * DebitCreditMemoAccountEntry filter form base class.
 *
 ...
 */
abstract class BaseDebitCreditMemoAccountEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('debit_credit_memo_account_entry_filters[%s]');
