...
/**
 * AccountsReceivableBeginningBalance filter form base class.
 *
 ...
 */
abstract class BaseAccountsReceivableBeginningBalanceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('accounts_receivable_beginning_balance_filters[%s]');
  ...
  {
    return 'AccountsReceivableBeginningBalance';
  }
