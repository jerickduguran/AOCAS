...
/**
 * ReceiptAccountEntryOutputVatEntry filter form base class.
 *
 ...
 */
abstract class BaseReceiptAccountEntryOutputVatEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'receipt_account_entry_output_vat_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ReceiptAccountEntryOutputVat'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('receipt_account_entry_output_vat_entry_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                                  => 'Number',
      'receipt_account_entry_output_vat_id' => 'ForeignKey',
