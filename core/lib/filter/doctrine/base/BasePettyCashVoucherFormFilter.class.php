...
/**
 * PettyCashVoucher filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_filters[%s]');
