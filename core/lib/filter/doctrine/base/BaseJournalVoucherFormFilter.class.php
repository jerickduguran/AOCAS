...
/**
 * JournalVoucher filter form base class.
 *
 ...
 */
abstract class BaseJournalVoucherFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('journal_voucher_filters[%s]');
