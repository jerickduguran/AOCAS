...
/**
 * CheckVoucherParticularEntry filter form base class.
 *
 ...
 */
abstract class BaseCheckVoucherParticularEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('check_voucher_particular_entry_filters[%s]');
  ...
  {
    return 'CheckVoucherParticularEntry';
  }
