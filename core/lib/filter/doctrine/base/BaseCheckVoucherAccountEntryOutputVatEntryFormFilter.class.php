...
/**
 * CheckVoucherAccountEntryOutputVatEntry filter form base class.
 *
 ...
 */
abstract class BaseCheckVoucherAccountEntryOutputVatEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'check_voucher_account_entry_output_vat_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('CheckVoucherAccountEntryOutputVat'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('check_voucher_account_entry_output_vat_entry_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                                        => 'Number',
      'check_voucher_account_entry_output_vat_id' => 'ForeignKey',
