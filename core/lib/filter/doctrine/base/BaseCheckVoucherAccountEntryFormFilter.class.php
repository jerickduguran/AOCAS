...
/**
 * CheckVoucherAccountEntry filter form base class.
 *
 ...
 */
abstract class BaseCheckVoucherAccountEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'check_voucher_id'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'check_voucher_id'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('check_voucher_account_entry_filters[%s]');
