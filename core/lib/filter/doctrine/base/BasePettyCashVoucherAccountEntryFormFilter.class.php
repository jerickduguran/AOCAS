...
/**
 * PettyCashVoucherAccountEntry filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherAccountEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_account_entry_filters[%s]');
