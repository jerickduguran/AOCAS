...
/**
 * AccountsPayableVoucherAccountEntryOutputVat filter form base class.
 *
 ...
 */
abstract class BaseAccountsPayableVoucherAccountEntryOutputVatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'accounts_payable_voucher_number' => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('accounts_payable_voucher_account_entry_output_vat_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                              => 'Number',
      'accounts_payable_voucher_number' => 'Text',
