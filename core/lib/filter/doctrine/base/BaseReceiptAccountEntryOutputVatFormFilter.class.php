...
/**
 * ReceiptAccountEntryOutputVat filter form base class.
 *
 ...
 */
abstract class BaseReceiptAccountEntryOutputVatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'receipt_number'      => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('receipt_account_entry_output_vat_filters[%s]');
  ...
  {
    return 'ReceiptAccountEntryOutputVat';
  }
