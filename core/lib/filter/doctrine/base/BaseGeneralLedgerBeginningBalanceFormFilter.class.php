...
/**
 * GeneralLedgerBeginningBalance filter form base class.
 *
 ...
 */
abstract class BaseGeneralLedgerBeginningBalanceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('general_ledger_beginning_balance_filters[%s]');
