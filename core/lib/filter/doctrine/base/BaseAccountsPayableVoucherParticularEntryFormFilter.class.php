...
/**
 * AccountsPayableVoucherParticularEntry filter form base class.
 *
 ...
 */
abstract class BaseAccountsPayableVoucherParticularEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('accounts_payable_voucher_particular_entry_filters[%s]');
  ...
  {
    return 'AccountsPayableVoucherParticularEntry';
  }
