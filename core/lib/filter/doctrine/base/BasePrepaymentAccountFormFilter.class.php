...
/**
 * PrepaymentAccount filter form base class.
 *
 ...
 */
abstract class BasePrepaymentAccountFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('prepayment_account_filters[%s]');
