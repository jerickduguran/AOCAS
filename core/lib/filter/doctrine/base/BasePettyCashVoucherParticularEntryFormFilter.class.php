...
/**
 * PettyCashVoucherParticularEntry filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherParticularEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'petty_cash_voucher_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('PettyCashVoucher'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'petty_cash_voucher_id'    => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PettyCashVoucher'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_particular_entry_filters[%s]');
