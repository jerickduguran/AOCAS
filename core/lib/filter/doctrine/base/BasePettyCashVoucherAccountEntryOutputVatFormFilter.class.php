...
/**
 * PettyCashVoucherAccountEntryOutputVat filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherAccountEntryOutputVatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_account_entry_output_vat_filters[%s]');
