...
/**
 * CheckVoucherAccountEntryOutputVat filter form base class.
 *
 ...
 */
abstract class BaseCheckVoucherAccountEntryOutputVatFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'check_voucher_number' => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('check_voucher_account_entry_output_vat_filters[%s]');
