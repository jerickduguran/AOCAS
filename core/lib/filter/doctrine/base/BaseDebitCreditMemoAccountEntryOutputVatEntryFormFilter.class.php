...
/**
 * DebitCreditMemoAccountEntryOutputVatEntry filter form base class.
 *
 ...
 */
abstract class BaseDebitCreditMemoAccountEntryOutputVatEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'debit_credit_memo_account_entry_output_vat_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('DebitCreditMemoAccountEntryOutputVat'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('debit_credit_memo_account_entry_output_vat_entry_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                                            => 'Number',
      'debit_credit_memo_account_entry_output_vat_id' => 'ForeignKey',
