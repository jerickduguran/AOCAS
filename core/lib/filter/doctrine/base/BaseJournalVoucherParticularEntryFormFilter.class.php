...
/**
 * JournalVoucherParticularEntry filter form base class.
 *
 ...
 */
abstract class BaseJournalVoucherParticularEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'journal_voucher_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('JournalVoucher'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'journal_voucher_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('JournalVoucher'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('journal_voucher_particular_entry_filters[%s]');
  ...
  {
    return 'JournalVoucherParticularEntry';
  }
