...
/**
 * PettyCashVoucherVoucherAccountEntry filter form base class.
 *
 ...
 */
abstract class BasePettyCashVoucherVoucherAccountEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('petty_cash_voucher_voucher_account_entry_filters[%s]');
