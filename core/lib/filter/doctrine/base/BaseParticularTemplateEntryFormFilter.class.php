...
/**
 * ParticularTemplateEntry filter form base class.
 *
 ...
 */
abstract class BaseParticularTemplateEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('particular_template_entry_filters[%s]');
