...
/**
 * BaseAccountsPayableVoucherParticularEntry
 * 
 ...
 * @method AccountsPayableVoucherParticularEntry setAccountsPayableVoucherId()    Sets the current record's "accounts_payable_voucher_id" value
 * @method AccountsPayableVoucherParticularEntry setTitle()                       Sets the current record's "title" value
 * @method AccountsPayableVoucherParticularEntry setAmount()                      Sets the current record's "amount" value
 * @method AccountsPayableVoucherParticularEntry setVatApplication()              Sets the current record's "vat_application" value
 * @method AccountsPayableVoucherParticularEntry setTaxExpandedWithheldId()       Sets the current record's "tax_expanded_withheld_id" value
 * @method AccountsPayableVoucherParticularEntry setTaxFinalWithheldId()          Sets the current record's "tax_final_withheld_id" value
 * @method AccountsPayableVoucherParticularEntry setTotal()                       Sets the current record's "total" value
 * @method AccountsPayableVoucherParticularEntry setAccountsPayableVoucher()      Sets the current record's "AccountsPayableVoucher" value
 * @method AccountsPayableVoucherParticularEntry setTaxExpandedWithheld()         Sets the current record's "TaxExpandedWithheld" value
 * @method AccountsPayableVoucherParticularEntry setTaxFinalWithheld()            Sets the current record's "TaxFinalWithheld" value
 * 
 ...
 */
abstract class BaseAccountsPayableVoucherParticularEntry extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('accounts_payable_voucher_particular_entry');
